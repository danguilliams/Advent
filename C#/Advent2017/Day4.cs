...
The system's full passphrase list is available as your puzzle input. How many passphrases are valid?
    ...
    public class Day4 : Puzzle
    {
        ...
        private List<List<string>> Passphrases = new List<List<string>>();
        ...
        private class AnagramComparer : IEqualityComparer<string>
        {
            public bool Equals(string x, string y)
            {
                ...
                {
                    // get strings in to arrays of chars
                    // sort
                    // compare arrays
                }
                return equal;
        ...
        private string day4_input = @"pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
