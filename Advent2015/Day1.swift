...
class Day1 : DayBase {
    ...
    init() {
        super.init(day:1 , content:input)
    }
    ...
    override func DoSolve()
    {
        ...
        let commands = input.characters.filter { $0 == ")" || $0 == "(" }
        for c in commands
        {
            count += 1
        ...
        print("  First Hit Basement On Floor Change: \(basementCount)")
        print("  Total Floor Changes: \(count)")
    }
